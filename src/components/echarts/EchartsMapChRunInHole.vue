...
<script src='https://webapi.amap.com/maps?v=1.3&key=e5b7f667b3971cc9d0dbf0eb657c788d&plugin=AMap.DistrictSearch'> </script>
<script src="https://webapi.amap.com/ui/3.0/main.js"></script>
<script>
// import mapDatasss from '../../../public/mapData.json'
export default {
  name:'mapChartRun',
  data(){
    return {
  ...
  methods:{
    ...
    getMapData() {
      ...
      // })
      let mapData = [
        {name: "北京市", value: [116.405285,39.904989,20], cityCode: 110000}
        ]
      console.log(mapData);
    ...
    initEcharts(mapData) {
      this.myChart = this.$echarts.init(this.$refs.dotMap)
